...
export default function Header({ menuItems }) {
  ...
  return (
    <>
      <header className="flex max-w-[1280px] mx-4 lg:mx-auto z-50 py-4 lg:flex lg:justify-between lg:items-center px-4 md:px-0">
        <div className='flex w-full lg:w-auto justify-between items-center'>
          <Link href="/" className="hover:underline">
            <Image src="/images/find-bilpleje.png" alt="Find Bilpleje - Logo" width={160} height={64} priority></Image>
          </Link>
